...
async def not_joined(client: Client, message: Message):
    ...
    if FORCE_SUB_CHANNEL1 and FORCE_SUB_CHANNEL2:
        buttons.append([
            InlineKeyboardButton(text="• ᴇᴛᴇʀɴᴀʟs", url=client.invitelink1),
            InlineKeyboardButton(text="ᴏɴɢᴏɪɴɢ ᴀɪʀɪɴɢs •", url=client.invitelink2),
        ])
    ...
    if FORCE_SUB_CHANNEL3 and FORCE_SUB_CHANNEL4:
        buttons.append([
            InlineKeyboardButton(text="• ᴍᴏᴠɪᴇ Aɪʀɪɴɢs", url=client.invitelink3),
