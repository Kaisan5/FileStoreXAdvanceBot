...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "<b><blockquote>Hᴇʟʟᴏ!! {first} ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ <a href=https://t.me/Anime_Eternals>Aɴɪᴍᴇ Eᴛᴇʀɴᴀʟs</a>  Yᴏᴜ ɴᴇᴇᴅ ᴛᴏ Jᴏɪɴ ɪɴ ᴍʏ Cʜᴀɴɴᴇʟ/Gʀᴏᴜᴘ ғɪʀsᴛ, Pʟᴇᴀsᴇ sᴜʙsᴄʀɪʙᴇ ᴛᴏ ᴏᴜʀ ᴄʜᴀɴɴᴇʟs ᴛʜʀᴏᴜɢʜ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ʙᴇʟᴏᴡ ᴀɴᴅ sᴛᴀʀᴛ ʙᴏᴛ ᴀɢᴀɪɴ, Fᴏʀ Oɴɢᴏɪɴɢ Aɴɪᴍᴇ ~ <a href=https://t.me/+vgZuyZzUjfhkNTI1>ᴏɴɢᴏɪɴɢ ᴀɪʀɪɴɢs </a> Jᴏɪɴ Tʜɪs Cʜᴀɴɴᴇʟ\n</a>Jᴏɪɴ ᴏᴜʀ Gʀᴏᴜᴘ ~ <a href=https://t.me/+C30sfk0zGLpkYTBl>Cʟɪᴄᴋ Hᴇʀᴇ </a>\n\n</a> Hᴇʟᴘʟɪɴᴇ Bᴏᴛ ~ <a href=https://t.me/EternalsHelplineBot>Hᴇʟᴘʟɪɴᴇ </a>\n\nFᴏʀ ʏᴏᴜʀ Sᴜᴘᴘᴏʀᴛ</a></blockquote></b></blockquote></b>")
